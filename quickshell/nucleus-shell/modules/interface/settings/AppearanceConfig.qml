...
ContentMenu {
    ...
    ContentCard {
            ...
            GridLayout {
                ...
                Repeater {
                    ...
                    delegate: StyledButton {
                        ...
                        onClicked: {
                            Config.updateKey("appearance.colors.matugenScheme", modelData);
                            Quickshell.execDetached(["qs", "-c", "nucleus-shell", "ipc", "call", "global", "regenColors"]);
                        }
                    }
        ...
        ColumnLayout {
            visible: presetGrid.themeList.length !== 0
                ...
                Repeater {
                    ...
                    delegate: StyledButton {
                        ...
                        onClicked: {
                            ...
                            Quickshell.execDetached(["bash", Directories.scriptsPath + "/interface/switchTheme.sh", modelData]);
                        }
                    }

                }

                // Process to list theme files
                Process {
                    id: loadThemes

                    // No bash, all args separate
                    command: ["ls", Directories.shellConfig + "/colorschemes"]
                    running: true

                    stdout: StdioCollector {
                        onStreamFinished: {
                            // Filter .json and remove extension
                            presetGrid.themeList = text.split("\n").map((t) => {
                                return t.trim();
                            }).filter((t) => {
